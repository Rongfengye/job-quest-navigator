...
-- and fully qualifying all object references in database functions
...
-- Update increment_user_monthly_usage function
...
-- Update ensure_user_usage_record function
...
-- Update check_user_monthly_usage function
...
-- Update get_user_monthly_usage_summary function
...
-- Update add_user_tokens function (backward compatibility)
...
-- Update deduct_user_tokens function (backward compatibility)
