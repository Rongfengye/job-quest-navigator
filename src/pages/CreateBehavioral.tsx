        ...
        <div className="text-center mb-8">
          <div className="mb-2">
            <span className="inline-block px-3 py-1 text-xs font-medium bg-blue-100 text-blue-800 rounded-full">
              Step 1 of 3 – Upload Your Resume & Job Details
            </span>
          </div>
          <h1 className="text-3xl md:text-4xl font-bold mb-3 text-interview-primary">
            Create a Personalized Interview Practice Plan
          </h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Get tailored behavioral questions based on your resume and job description.
          </p>
        </div>
